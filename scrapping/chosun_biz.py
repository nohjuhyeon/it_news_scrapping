...
# collection 작업
collection = database['healthcare']
# Chrome 브라우저 옵션 생성
...
for j in range(len(page_list)):
    ...
    for i in range(len(news_list)):
        ...
        news_date = browser.find_element(by=By.CSS_SELECTOR,value='#fusion-app > div.article > div:nth-child(2) > div > section > article > div.article-dateline.\|.flex.flex--justify-space-between.flex--align-items-top.box--border.box--border-grey-40.box--border-horizontal.box--border-horizontal-bottom.box--pad-bottom-sm > span > span').text.split()[1]
